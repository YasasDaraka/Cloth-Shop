    ...
    return (
        <>
            <div className="flex justify-center align-items-center h-full w-full">
                ...
                <div className="w-1/2 h-2/3 bg-amber-800">
                ...
                <div className="w-1/2 h-2/3">
                    ...
                    <div className={"flex w-full px-3 h-[26vh]"}>
                        ...
                        <div className={"flex w-2/5 h-full bg-amber-500"}></div>
                    </div>
                    <div className={"flex-row w-full px-3 h-[26vh] bg-amber-400"}>
                        <div className={"flex items-center justify-evenly w-full h-2/5 bg-black"}>
                        ...
                        <div className={"flex items-center w-full h-2/5 bg-blue-400"}>
                            <Input
                                type="text"
                                name="cash"
                        ...
                        <div className={"flex w-full h-2/5 bg-black"}></div>
                    </div>
                </div>
            </div>
        </>
